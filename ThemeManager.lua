...
local ThemeManager = {} do
	ThemeManager.Folder = 'LunaflagSettings'
	ThemeManager.Library = nil
	ThemeManager.DefaultTheme = 'Lunaflag'

	ThemeManager.BuiltInThemes = {
		['Lunaflag'] 		= { 1, httpService:JSONDecode('{"FontColor":"e8e0f0","MainColor":"1a1525","AccentColor":"9b6dff","BackgroundColor":"120e1a","OutlineColor":"2e2640"}') },
		['Default'] 		= { 2, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"1c1c1c","AccentColor":"6490ff","BackgroundColor":"141414","OutlineColor":"323232"}') },
		...
		['Dark Purple'] 	= { 10, httpService:JSONDecode('{"FontColor":"f0e6ff","MainColor":"1c1628","AccentColor":"a855f7","BackgroundColor":"110d1a","OutlineColor":"3b2f52"}') },
	}
	...
	function ThemeManager:LoadDefault()		
		local theme = self.DefaultTheme or 'Lunaflag'
